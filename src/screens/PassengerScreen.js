  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.options}>
        <View style={{backgroundColor:"white",borderRadius:20,padding:10,flex:0.9}}>
          <TouchableOpacity onPress={switchmode}>
            <Text style={[styles.hometext,{textAlign:"center"}]}>Rider</Text>
          </TouchableOpacity>
        </View>
    
        <View style={{backgroundColor:"black",borderRadius:20,padding:10,flex:1.1}}>
          <TouchableOpacity onPress={switchmode}>
            <Text style={[styles.hometext,{textAlign:"center",color:"white"}]}>Passenger</Text>
          </TouchableOpacity>
        </View>
    </View>
